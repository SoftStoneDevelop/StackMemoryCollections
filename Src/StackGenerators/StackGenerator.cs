...
namespace {currentType.ContainingNamespace}.Struct
{{
    public unsafe struct StackOf{currentType.Name} : IDisposable, IEnumerable<{currentType.Name}>
    {{
        private readonly StackMemoryCollections.Struct.StackMemory* _stackMemoryS;
        private readonly StackMemoryCollections.Class.StackMemory? _stackMemoryC = null;
        private readonly void* _start;
        ...
        public IEnumerator<{currentType.Name}> GetEnumerator()
        {{
        ...
        public struct Enumerator : IEnumerator<{currentType.Name}>, IEnumerator
        {{
...
//namespace {currentType.ContainingNamespace}.Class
//{{
//    public unsafe class StackOf{currentType.Name} : IDisposable, IEnumerable<{currentType.Name}>
//    {{
//        private readonly StackMemoryCollections.Struct.StackMemory* _stackMemoryS;
//        private readonly StackMemoryCollections.Class.StackMemory? _stackMemoryC = null;
//        private readonly void* _start;
